...
for i in range(10):
    ...
    train_predictions = best_gbdt.predict(X_train)
    val_predictions = best_gbdt.predict(X_val)
    test_predictions = best_gbdt.predict(X_test)
